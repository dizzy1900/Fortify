...
import { Archive, BookOpenCheck, BriefcaseBusiness, Building2, CalendarDays, ChevronLeft, ChevronRight, ClipboardCheck, FileCheck2, FileSearch, FileText, Gauge, GitBranch, History, Home, KeyRound, LayoutDashboard, Menu, PackageCheck, RotateCcw, Settings, ShieldCheck, UploadCloud, X } from "lucide-react";
