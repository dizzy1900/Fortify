...
import { Archive, BookOpenCheck, BriefcaseBusiness, Building2, CalendarDays, ChevronLeft, ChevronRight, ClipboardCheck, FileCheck2, FileKey2, FileSearch, FileText, Gauge, GitBranch, History, Home, KeyRound, LayoutDashboard, Menu, PackageCheck, RotateCcw, Settings, ShieldCheck, UploadCloud, X } from "lucide-react";
import { useState, type ReactNode } from "react";
import { useDemo } from "./demo-provider";

const nav = [
  ["Portfolio", "/portfolio", LayoutDashboard], ["California brokerage", "/brokerage", BriefcaseBusiness], ["Property graph", "/property-graph", GitBranch], ["Identity & access", "/access", KeyRound], ["SOV import", "/imports", UploadCloud], ["Document intake", "/documents", FileSearch], ["Source register", "/sources", FileKey2], ["Market playbooks", "/playbooks", BookOpenCheck], ["Community", "/community", Building2], ["Policy timeline", "/policy", CalendarDays], ["Carrier notice", "/notice", FileText], ["Requirement crosswalk", "/requirements", ClipboardCheck], ["Evidence room", "/evidence", Archive], ["Renewal case", "/case", Gauge], ["Packet builder", "/packet", PackageCheck], ["Underwriter review", "/underwriter", ShieldCheck], ["Outcome", "/outcomes", FileCheck2], ["Maintenance", "/maintenance", CalendarDays], ["Reports & audit", "/reports", History], ["Settings", "/settings", Settings],
] as const;
const guide = [
