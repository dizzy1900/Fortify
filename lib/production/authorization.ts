...
const roleScopes: Record<OrganizationRole, ReadonlySet<string>> = {
  ...
  practice_leader: new Set([
    ...
    ...writeScopes("book", "client", "market", "program", "requirement_set", "requirement", "requirement_version", "import_mapping", "import_mapping_version", "portfolio_import", "import_row", "import_receipt", "document_processing_job"),
  ...
  marketer: new Set([
    ...readScopes(...commonCaseResources, "market", "program", "requirement_set", "requirement", "requirement_version", "audit_event", "document_processing_job", "document_processing_attempt", "document_extraction_run"),
  ...
  assistant: new Set([
    ...readScopes(...commonCaseResources, "requirement", "requirement_version", "document_processing_job", "document_processing_attempt", "document_extraction_run"),
  ...
  underwriter_reviewer: new Set([
    ...readScopes("community", "property", "policy", "renewal_case", "source_document", "source_passage", "extracted_field", "extracted_field_review", "document_fact", "requirement", "requirement_version", "evidence_item", "evidence_version", "evidence_requirement_link", "contradiction", "submission", "submission_version", "submission_item"),
