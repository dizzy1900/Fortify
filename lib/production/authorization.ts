...
export const resourceClasses = [
  ...
  "recognition_submission_mapping",
  "submission_delivery",
  "delivery_receipt",
  "reviewer_session",
  "reviewer_request",
  "reviewer_request_response",
  "evidence_acceptance_event",
  "model_response_event",
  "rating_treatment_event",
  "underwriting_treatment_event",
  "placement_response_event",
  "funding_response_event",
  "recognition_case_closure_event",
  "maintenance_roll_forward",
  "programme_cohort",
  "programme_cohort_version",
  "programme_cohort_membership_event",
  "analytics_policy_version",
  "analytics_policy_review",
  "analytics_policy_publication",
  "recognition_graph_event",
  "workflow_baseline",
  "programme_metric_snapshot",
  "analytics_report",
  "analytics_report_artifact",
  "analytics_query_receipt",
  "integration_connection",
  "integration_connection_event",
  "integration_schema_version",
  "integration_sync_job",
  "integration_sync_attempt",
  "integration_sync_receipt",
...
const roleScopes: Record<OrganizationRole, ReadonlySet<string>> = {
  ...
  insurer_mga_reviewer: new Set([
    ...
    ...readScopes("recognition_submission_binding", "recognition_submission_mapping", "submission_delivery", "delivery_receipt", "reviewer_session", "reviewer_request", "reviewer_request_response", "evidence_acceptance_event", "model_response_event", "rating_treatment_event", "underwriting_treatment_event", "placement_response_event", "recognition_case_closure_event"),
    ...writeScopes("market_response", "reviewer_request", "evidence_acceptance_event", "model_response_event", "rating_treatment_event", "underwriting_treatment_event", "placement_response_event"),
    "data_access_log:create",
  ]),
  ...
  lender_funder_reviewer: new Set([
    ...
    ...readScopes("recognition_submission_binding", "recognition_submission_mapping", "submission_delivery", "delivery_receipt", "reviewer_session", "reviewer_request", "reviewer_request_response", "funding_response_event", "recognition_case_closure_event"),
    ...writeScopes("payment_approval", "reviewer_request", "funding_response_event"),
    "data_access_log:create",
  ]),
