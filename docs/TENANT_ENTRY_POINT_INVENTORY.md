...
| ---------------------------------------------- | ----: | ------------------------------------------------------------------------------------------------------------- |
| Authenticated production routes                |   120 | 4 brokerage routes bound; 116 still use principal resolution followed by an unbound service/database instance |
...
| Total enumerated tenant-sensitive entry points |   127 | 8 bound; 119 unbound                                                                                          |
