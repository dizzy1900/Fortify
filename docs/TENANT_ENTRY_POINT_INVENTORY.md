...
| ---------------------------------------------- | ----: | ----------------------------------------------------------------------------------------------------------------------------- |
| Authenticated production routes                |   120 | 12 access/brokerage/storage routes bound; 108 still use principal resolution followed by an unbound service/database instance |
...
| Total enumerated tenant-sensitive entry points |   127 | 16 bound; 111 unbound                                                                                                         |
