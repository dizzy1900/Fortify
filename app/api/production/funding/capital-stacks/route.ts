...
export async function POST(request: NextRequest) {
  try {
    ...
    return Response.json(await getProductionFundingProjectService().createCapitalStack(principal.authorization, await request.json() as CapitalStackInput), { status: 201 });
